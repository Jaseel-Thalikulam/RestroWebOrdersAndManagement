        ...
        >
          ...
          onChange={() => {
            setIsFoodTypesExist(!isFoodTypesExist);
                ...
                style={{ backgroundColor: isFoodTypesExist ? '#CD5C08' : '#000000' }}
          />
            </div>
                  ...
                  {(fields, { add, remove }) => (
                    <>
                        ...
                        <div key={index}>
                          ...
                          <Space key={key} align="baseline" className="form-commodity-row">
                            ...
                            <Form.Item
                              ...
                              name={[name, 'Type']}
                              rules={[
                                { required: true, message: 'Enter Valid Type' ,pattern: /^[A-Za-z\s]+$/}
                            ...
                            <Form.Item
                              ...
                              type='number'
                              name={[name, 'TypePrice']}
                              rules={[{ required: true, message: 'Enter Valid Price' ,pattern: new RegExp(/^[0-9]+$/) },
                            ...
                            <Form.Item
                              ...
                              rules={[{ message: 'Enter valid Offer Percentage',pattern: new RegExp(/^[1-9][0-9]?$|^99$/) },
                           ]}
                            >
                      ...
                      <Form.Item className="mt-3 text-center"  >
                        <Button  shape="round" type="dashed" onClick={() => add()}  icon={<PlusOutlined  />  }
                        >
                          Add More Type
                        </Button>
                      </Form.Item>
