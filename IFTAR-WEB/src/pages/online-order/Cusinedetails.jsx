...
const Cusinedetails = () => {
  ...
  const getPriceAndOffers = (data) => {
    ...
    console.log(isMultiTyped,"isMultiTyped");
    if (isMultiTyped) {
      ...
      return {
        ...
        OfferPrice: maxPrice,
      OfferPercentage:correspondingOfferPercentage
      }
  ...
  return (
    <div className="w-screen lg:px-20 px-2  flex flex-col lg:gap-y-10 min-h-screen lg:pb-20 pb-5">
      <div className="flex flex-col lg:gap-y-14 gap-y-8">
          ...
          <div className="flex flex-col lg:gap-y-10 gap-y-8">
            ...
            <div className="p-2 pl-5 items-center flex px-3 gap-4" >
              ...
              <input
                ...
                style={{ borderColor: `${isNonVegOnly ? `red` : 'grey'}`, backgroundColor: `${isNonVegOnly ? `red` : 'grey'}` }}
              />
        ...
        style={{ borderColor: `${isVegOnly?`green`:'grey'}`,backgroundColor:`${isVegOnly?`green`:'grey'}` }}
              />
                    ...
                    <div className="flex flex-col gap-y-1 px-2 ultraSm:w-1/3">
                      ...
                      {res.offer != 0 ? (
                        <div className="flex items-center gap-2">
                          ...
                          >
                            <CiDiscount1 className="text-white text-sm font-bold" />
                            {res.offer?res.offer:_.get(getPriceAndOffers(res), "OfferPercentage", 0)}% Discount
                          </Tag>
                        </div>
                      ) : null}
                      <div className="text-[#262525] ultraSm:text-sm  lg:text-xl flex items-center gap-x-2 ">
